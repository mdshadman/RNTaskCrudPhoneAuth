        ...
        <Container>
            ...
            <Content>
                ...
                <Grid>
                    ...
                    <Row style={{ height: 50 }}>
                        <Col style={styles.col1}><Text>Name</Text></Col>
                        <Col style={styles.col2}><Text>Status</Text></Col>
                        <Col style={styles.col3}><Text>Image</Text></Col>
                    </Row>


                    {userData.map((data, index) => {
                        return (
                            <Row style={styles.rowContent} key={index}>
                                <Col>
                                    <Card>
                                        <CardItem>
                                            <Left>
                                        ...
                                        <Button iconLeft success style={styles.buttonStyle} onPress={() => goToUpdate(data)}>
                                            <Icon name='create' color='red' />
                                            <Text>Update</Text>
                                        </Button>

                                        <Button iconLeft danger style={styles.buttonStyle} onPress={() => deleteTask(data.id)}>
